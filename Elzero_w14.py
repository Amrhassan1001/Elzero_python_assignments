...
class User:
    ...
    def full_details(self):
        if self.gender == "Male":
            return f"Hello Mr {self.name1} {self.name2[0]}. [{str(40 - self.age).zfill(2)}] Years To Reach 40"
        elif self.gender == "Female":
            return f"Hello Mrs {self.name1} {self.name2[0]}. [{str(40 - self.age).zfill(2)}] Years To Reach 40"
        pass
